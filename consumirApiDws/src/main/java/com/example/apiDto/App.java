...
public class App {
	public static void main(String[] args) {
		...
		try {
			...
			// Obtener la respuesta JSON de la API de usuarios
			...
			// Convertir la respuesta JSON en objetos Java usando Jackson
			...
			// Obtener la respuesta JSON de la API de accesos
